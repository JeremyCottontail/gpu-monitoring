        ...
        <header className="flex flex-wrap items-start justify-between gap-4">
          ...
          <div className="flex gap-2">
            <div className="rounded-2xl bg-gradient-card px-4 py-3 text-right">
              ...
              <p className="font-display text-xl text-white">{formatPercent(gpu.utilization)}</p>
            </div>
            <div className="rounded-2xl bg-gradient-card px-4 py-3 text-right">
              <p className="text-xs text-slate-300">Mem</p>
              <p className="font-display text-xl text-white">{formatPercent(gpu.memoryUsed && gpu.memoryTotal ? (gpu.memoryUsed / gpu.memoryTotal) * 100 : 0)}</p>
            </div>
          </div>
        </header>
